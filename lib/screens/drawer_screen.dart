...
import 'package:note_app_flutter_sqflite_provider/widgets/dialog_activate.dart';
...
class DrawerScreen extends StatelessWidget {
 ...
 static   String?  asyncM()    {
   print("zcx "+activ.toString());

   SharedPreferences.getInstance().then((instance) =>{
     activ =  (instance.getString('action').toString() =="1")
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      ...
      ShaderMask(
            ...
            child: Padding(
              padding:
                  (context.watch<LocaleProvider>().locale.languageCode != 'ru')
          ...
          CustomListTileWidget(
            ...
            onTap: () {
              showDialog(
                context: context,
                barrierDismissible: false,
                builder: (context) => const DialogActivate(),
              );
            },
          )  ),
