...
class _EditNoteScreenState extends State<EditNoteScreen> {
  ...
  void initState() {
    ...
    _title = widget.note?.a_title ?? '';
    _content = widget.note?.a_content ?? '';
    _bgColor = widget.note?.bgcolors_id ?? ColorsConstant.labelColor;
    _imagePaths = widget.note?.imagePaths ?? [];
    _owner='123';
    if (_defaultLabel.isNotEmpty) {
      _label = _defaultLabel;
    } else {
      _label = widget.note?.labels_id ?? '';
    }
  }
  ...
  Widget build(BuildContext context) {
      ...
      return    AnnotatedRegion(
        value: SystemUiOverlayStyle(systemNavigationBarColor:  ColorsConstant.darkDarkBlueColor),
        // color: ColorsConstant.darkBlueColor,
        ...
        child: WillPopScope(
          ...
          child: Scaffold(
            backgroundColor: ColorsConstant.darkBlueColor,
              ...
              Padding(
                  ...
                  child: CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        color: ColorsConstant.iconColor,
              ...
              child:       Padding(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            primary: ColorsConstant.orangeColor1,
                  ...
                  Expanded(
                    child: Center(
                      child: Text(
                        ...
                        style: const TextStyle(                  color: ColorsConstant.iconColor
                        ),
                      ),
                    ),
                  ),
  ...
  _addNote() {
    final note = Note(
      id_a: DateTime.now().millisecondsSinceEpoch.toString(),
      a_title: _title.trim(),
      a_content: _content.trim(),
      a_time_create: DateTime.now(),
      labels_id: _label,
      imagePaths: _imagePaths,
      bgcolors_id: _bgColor,
      users_id: _owner,
    );
  ...
  _deleteNote() async {
    if (widget.note != null) {
      ...
      if (action == true) {
        await context.read<NoteProvider>().delete(widget.note!.id_a);
